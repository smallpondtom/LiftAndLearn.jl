...
mergingsketchy = iSVD(algo=:mergingsketchy; m=kse.spatial_dim, b=200, r=rmax, ReduxMap=:Sparse)
...
push!(time_brand, tmp)
# sketchy
tmp = @elapsed sketchy = iSVD(algo=:sketchy; m=kse.spatial_dim, n=num_of_streams, 
...
tmp = @elapsed mergingsketchy = iSVD(algo=:mergingsketchy; m=kse.spatial_dim, b=blksize, r=rmax, ReduxMap=:Sparse)
